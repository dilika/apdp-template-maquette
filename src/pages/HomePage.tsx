    ...
    <div>
      <section className="bg-green-700 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <button className="bg-white text-green-700 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition duration-300">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <button className="bg-green-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-green-700 transition duration-300 inline-flex items-center">
